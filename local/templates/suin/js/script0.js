...
$.fn.suin = function(){
	...
	/* ---- Agent form ---- */
	$root.find('.js-agent-form').each(function(){
		var $frm = $(this),
	...
	$root.find('.b-header__promo').each(function(){
		...
		var moveTo = function(index){
			...
			if (clickSlide == 1){
				image.animate({'left': -430, 'right': -430, 'top': 0},650);
				$('.b-header__promo-text').fadeOut()
				$('.b-header__promo-text').eq(0).fadeIn()
			}
			
			if (clickSlide == 2){
				image.animate({'left': -1630, 'right': -1630, 'top': 0},650);
				$('.b-header__promo-text').fadeOut()
				$('.b-header__promo-text').eq(1).fadeIn()				
			}
			
			if (clickSlide == 3){
				image.animate({'left': -1625, 'right': -1625, 'top': -670},650);
				$('.b-header__promo-text').fadeOut()
			...
			if ($(window).width() >= 1600){
				if (clickSlide == 4){
					image.animate({'left': -2515, 'right': -2515, 'top': -675},650);
					$('.b-header__promo-text').fadeOut()
					$('.b-header__promo-text').eq(3).fadeIn()					
				}
			} else if ($(window).width() < 1600){
				if (clickSlide == 4){
					image.animate({'left': -2815, 'right': -2815, 'top': -675},650);
					$('.b-header__promo-text').fadeOut()
					$('.b-header__promo-text').eq(3).fadeIn()							
				}
 			} 
